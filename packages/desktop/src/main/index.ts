...
const APP_NAMES: Record<string, string> = {
  dev: "Jerry AI IDE Dev",
  beta: "Jerry AI IDE Beta",
  prod: "Jerry AI IDE",
}
...
const main = Effect.gen(function* () {
  ...
  const appId = app.isPackaged ? APP_IDS[CHANNEL] : "ai.jerry.desktop.dev"
  const onboardingTestRoot = ((): string | undefined => {
    if (!TEST_ONBOARDING) return

    const root = join(tmpdir(), `jerry-onboarding-${randomUUID()}`)
  ...
  app.setName(app.isPackaged ? APP_NAMES[CHANNEL] : "Jerry AI IDE Dev")
